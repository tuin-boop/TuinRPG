...
Five-level milestones award increasing perk bundles, reaching 23 total points at level 30—enough to complete every perk available to one build. The first point permanently chooses Heavy, Healer, Executioner, Doom Guy, Rogue, or Engineer under **K > Class and Perks**. Later points buy ranked health, ammunition, critical, protection, leech, Giant Slayer, and class perks. Class Ultimates and Giant Slayer unlock at level 20.

Each class has a distinct V ability. Heavy charges Overdrive by dealing and taking damage; `B` separately performs a slow radio call for two or three invulnerable allied marines that fight for 30 seconds. The full Overdrive threshold is now `1040 + 65 × player level`. After each radio call, only actual monster damage restores it: it needs 4,095 damage before training, while simply waiting gives nothing. The marines aggressively scan for visible enemies, closely follow their Heavy with smooth FriendJohn-style lateral movement, and teleport to catch up without vertical hopping. Heavy starts with 175 base maximum health and a Minigun, deals full weapon damage, has triple bullet capacity, moves 20% slower, and gains 5 extra maximum health per Strength point. Healer throws Field Supplies. Executioner arms Death Sentence and judges up to three targets with the next weapon hit. Doom Guy receives a class-exclusive Quad Shotgun, holds V to ready Blood Punch, and releases it to strike. Rogue charges Shadow Veil by dealing weapon damage, then uses it to become untargetable until an ambush or the veil expires. Engineer places one persistent auto-turret that automatically attacks visible hostiles with physical 3D tracer rounds; press V near it to pack it without losing its remaining health or ammunition. If it breaks or empties, kills and ammo pickups rebuild its Fabrication meter. Its Ultimate unlocks a second independently maintained turret.
