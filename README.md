...
- A permanent first-perk class choice: Tank (300 base HP, 50% protection, -50% damage, +100% ammo, and Overdrive), Healer (team-wide 5 HP healing every two seconds, -25% damage, +25% ammo), Damage Dealer (+30% damage, -25% maximum health, +10% damage taken), Doom Guy (+10% damage, 10% protection, regeneration, and Blood Punch), or Rogue (20% lower maximum health and an actively triggered Shadow Veil). The choice costs one perk point.
