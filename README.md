...
From player level 15 onward, natural Rare-or-higher monster rolls are assigned across the complete starting roster with a heavy preference: Baron-or-stronger candidates first, then Hell Knight-or-stronger candidates, and Cacodemons or lower only when those preferred groups are exhausted. This preserves the original number and grades of random rarity rolls and is separate from the Hell Director's mid-level promotions.
