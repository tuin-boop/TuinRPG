...
| **Rogue** | Has 20% less maximum health, +5% critical chance, causes critical hits and every knife strike to bleed enemies, and can actively trigger Shadow Veil for a powerful ambush |
...
- Rogues have +5% innate critical chance. Their critical hits, including forced Ambush criticals, inflict eight seconds of bleeding that repeats the triggering critical hit's total damage over eight ticks, capped at 24% of the target's RPG-scaled maximum health. Ordinary critical Bleeding cannot refresh or stack, and the monster resists it for 12 seconds after it ends. Every Rogue Knife hit is the exception: its Bleed accumulates and refreshes, adding twice the hit's damage normally or four times its damage from a Shadow Veil ambush, with respective 24% and 36% health ceilings. On iconic episode-end bosses, those stackable knife ceilings are reduced to 10% normally and 15% from stealth. Critical hits still deal normal critical damage during these states. Bleeding appears on the target display and overhead health bar, with red floating damage numbers. Rogue Class Training adds another +2% critical chance per rank.
