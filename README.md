...
- The Rogue-exclusive **Venom Bow** occupies slot 3 and has a three-shot magazine with no alt-fire. Each direct bolt adds poison equal to 50% of that hit and refreshes a six-second stack, up to 15% of normal enemy maximum health, 8% for RPG bosses, or 4% for iconic finale bosses. Green damage numbers distinguish poison ticks. Once a Rogue owns the bow, killed monsters have a small rarity-scaled chance to drop a six-bolt bundle that non-Rogues cannot consume.
