...
| Class | Core role |
| --- | --- |
| **Tank** | 50% less damage taken, 40% less damage dealt and 40% more ammunition gained |
...
| **Doom Guy** | Deals 10% more damage, takes 10% less damage and regenerates 1 HP every ten seconds |
| **Rogue** | Has 20% less maximum health and enters an indefinite Shadow Veil after standing still; the veil breaks into a powerful ambush |

Later points buy three ranks of **Vital Core**, **Scavenger**, **Killer Instinct**, **Iron Skin**, **Blood Drinker** and class-specific training. A permanent class capstone becomes available at level 20 after Class Training II. The Rogue's fixed 15-second cooldown begins when Shadow Veil breaks; its ambush deals x4 weapon damage or x20 fist/knuckle damage.
...
- A permanent first-perk class choice: Tank (50% protection, -40% damage, +40% ammo), Healer (team-wide 5 HP healing every two seconds, -25% damage, +25% ammo), Damage Dealer (+30% damage, -25% maximum health, +10% damage taken), Doom Guy (+10% damage, 10% protection, and 1 HP regeneration every ten seconds), or Rogue (20% lower maximum health and a stationary-triggered Shadow Veil). The choice costs one perk point.
- Rogue's Shadow Veil becomes available after its fixed 15-second cooldown and activates after standing still for 1.5 seconds. It remains active indefinitely, makes the player half translucent and untargetable, and forces monsters to disengage and wander. Attacking, using, or taking damage breaks it. Its ambush attack deals x4 weapon damage or x20 fist/knuckle damage; iconic finale bosses use reduced x2 ranged and x5 melee multipliers. Rogue Class Training shortens the stationary activation time.
...
- Floating combat damage numbers rise and curl away from hit monsters; rapid pellet hits merge into a readable total and critical hits appear larger and gold.
...
Weapon variants can roll firing speed, damage, damage leech, execution damage, kill XP, or critical chance. Critical hits deal double damage. The player begins with 2% critical chance, Luck adds 0.5% per point, and a Keen Godly weapon can add up to 16% at item level 40. A maximum-level Godly roll can reach roughly +42% firing speed, +42% damage, +43% execution damage, +42% kill XP, or 14% leech depending on its four selected affixes. Equipping a Godly variant also creates an icy-white first-person pulse without replacing the underlying weapon actor.
