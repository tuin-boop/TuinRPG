...
- Later perk points purchase three ranks of Vital Core (+10 HP/rank), Scavenger (+10% ammo/rank), Killer Instinct (+2% critical chance/rank), Iron Skin (-3% incoming damage/rank), Blood Drinker (1% damage leech/rank), and a class-specific specialty. At level 20, **Giant Slayer** becomes available: its three ranks multiply complete attack damage by 1.10, 1.20, or 1.30 against enemies whose RPG-scaled maximum health is at least 2,500. This is bonus damage on the attack itself, not a percentage of the monster's health. Bleed, venom, rocket burn and plasma arcs inherit the stronger triggering hit and do not multiply a second time. Blood Drinker and weapon leech count every damaging hit, carrying fractional healing between low-damage bullets and pellets instead of losing it to rounding. A level-20 Class Ultimate requires Class Training II.
