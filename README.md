...
| Class | Core role |
| --- | --- |
| **Heavy** | 175 base health, 25% less damage taken, full weapon damage, 20% slower movement, triple bullet capacity, a starting Minigun, damage-powered Overdrive, and Radio Support |
...
- A permanent first-perk class choice: Heavy (175 base HP, +5 max HP per Strength, 25% protection, full weapon damage, 20% slower movement, triple bullet capacity, a starting Minigun, Overdrive, and Radio Support), Healer (team-wide 5 HP healing every two seconds, -25% damage, +25% ammo, and a V-key Field Supply toss), Executioner (+30% damage, -25% maximum health, Judgment and Death Sentence), Doom Guy (+10% damage, 10% protection, regeneration, a Quad Shotgun, and Blood Punch), Rogue (20% lower maximum health, 10% more incoming damage, 50% lower maximum ammo, and an actively triggered Shadow Veil), or Engineer (a deployable physical-tracer auto-turret). The choice costs one perk point.
